...
namespace Plugin.BarcoG60
{
        ...
        IBridgeAdvanced
    {
            ...
            : base(key, name)
        {
            ...
            HasLampsFeedback = new BoolFeedback(() => HasLamps);
            HasScreenFeedback = new BoolFeedback(() => HasScreen);
            HasLiftFeedback = new BoolFeedback(() => HasLift);
        ...
        /// <summary>
        /// LinkToDisplayCustomApi
        /// </summary>
        /// <param name="trilist"></param>
        /// <param name="joinStart"></param>
        /// <param name="joinMapKey"></param>
        /// <param name="bridge"></param>
        public void LinkDisplayCustomToApi(BasicTriList trilist, uint joinStart, string joinMapKey, EiscApiAdvanced bridge)
        {
            ...
            // links to bridge
            //trilist.SetString(joinMap.DeviceName, Name);

            HasLampsFeedback.LinkInputSig(trilist.BooleanInput[joinMap.HasLamps.JoinNumber]);
            HasScreenFeedback.LinkInputSig(trilist.BooleanInput[joinMap.HasScreen.JoinNumber]);
            HasLiftFeedback.LinkInputSig(trilist.BooleanInput[joinMap.HasLift.JoinNumber]);
        }
        ...
        #region Projector sepcific configurations

        /// <summary>
        /// Has lamps feedback
        /// </summary>
        public BoolFeedback HasLampsFeedback;

        // has lamps field
        private bool _hasLamps;

        /// <summary>
        /// Has lamps property
        /// </summary>
        public bool HasLamps
        {
            get { return _hasLamps; }
            private set
            {
                _hasLamps = value;
                HasLampsFeedback.FireUpdate();
            }
        }
        ...
        /// Has Screen feedback
        /// </summary>
        public BoolFeedback HasScreenFeedback;
        ...
        /// Has Lift feedback
        /// </summary>
        public BoolFeedback HasLiftFeedback;

        // has Lift field
        private bool _hasLift;
